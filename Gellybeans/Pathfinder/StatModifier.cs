namespace Gellybeans.Pathfinder
{
    public class StatModifier
    {
        ...
        public static Dictionary<string, List<StatModifier>> Mods = new Dictionary<string, List<StatModifier>>()
        {
            ...
            //transmutations       
            ///animal growth
            { "ANIMAL_GROWTH", new List<StatModifier>(){
            ...
            { "MAGICAL_BEAST_SHAPE_DIMINUTIVE", new List<StatModifier>(){
                new StatModifier("DEX_TEMP")        { Bonus = new Bonus() { Name = "BEAST_SHAPE", Type = BonusType.Size, Value = 10     }},
                new StatModifier("STR_SCORE")       { Bonus = new Bonus() { Name = "BEAST_SHAPE", Type = BonusType.Penalty, Value = -4  }}}},
            { "MAGICAL_BEAST_SHAPE_TINY", new List<StatModifier>(){
                new StatModifier("AC_BONUS")        { Bonus = new Bonus() { Name = "BEAST_SHAPE", Type = BonusType.Natural, Value = 3   }},
                new StatModifier("DEX_TEMP")        { Bonus = new Bonus() { Name = "BEAST_SHAPE", Type = BonusType.Size, Value = 8      }},
                new StatModifier("STR_SCORE")       { Bonus = new Bonus() { Name = "BEAST_SHAPE", Type = BonusType.Penalty, Value = -2  }}}},
            ...
            { "MAGICAL_BEAST_SHAPE_LARGE", new List<StatModifier>(){
                new StatModifier("AC_BONUS")        { Bonus = new Bonus() { Name = "BEAST_SHAPE", Type = BonusType.Natural, Value = 6   }},
                new StatModifier("DEX_SCORE")       { Bonus = new Bonus() { Name = "BEAST_SHAPE", Type = BonusType.Size, Value = -2     }},
                new StatModifier("STR_TEMP")        { Bonus = new Bonus() { Name = "BEAST_SHAPE", Type = BonusType.Penalty, Value = 6   }}}},
            { "MAGICAL_BEAST_SHAPE_HUGE", new List<StatModifier>(){
                new StatModifier("AC_BONUS")        { Bonus = new Bonus() { Name = "BEAST_SHAPE", Type = BonusType.Natural, Value = 7   }},
                new StatModifier("DEX_SCORE")       { Bonus = new Bonus() { Name = "BEAST_SHAPE", Type = BonusType.Penalty, Value = -4  }},
                new StatModifier("CON_TEMP")        { Bonus = new Bonus() { Name = "BEAST_SHAPE", Type = BonusType.Size, Value = 2      }},
                new StatModifier("STR_TEMP")        { Bonus = new Bonus() { Name = "BEAST_SHAPE", Type = BonusType.Size, Value = 8      }}}},
            ///naga
            ...
            { "ENLARGE_PERSON", new List<StatModifier>(){
                ...
                //new StatModifier("SIZE_SKL")        { Bonus = new Bonus() { Name = "ENLARGE_PERSON", Type = BonusType.Typeless, Value = -2 }}}},
