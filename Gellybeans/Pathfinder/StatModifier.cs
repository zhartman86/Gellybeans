    ...
    public class StatModifier
    {
        ...
        {     
            ...
            { "ENLARGE_PERSON_DIMINUTIVE", new List<StatModifier>(){
                ...
                new StatModifier("SIZE_MOD")        { Bonus = new Bonus() { Name = "ENLARGE_PERSON", Type = BonusType.Typeless, Value = -4  }},
            ...
            { "ENLARGE_PERSON_TINY", new List<StatModifier>(){
                new StatModifier("STR_TEMP")        { Bonus = new Bonus() { Name = "ENLARGE_PERSON", Type = BonusType.Size, Value = 2       }},
                new StatModifier("DEX_SCORE")       { Bonus = new Bonus() { Name = "ENLARGE_PERSON", Type = BonusType.Typeless, Value = -2  }},
                new StatModifier("SIZE_MOD")        { Bonus = new Bonus() { Name = "ENLARGE_PERSON", Type = BonusType.Typeless, Value = -2  }},
                new StatModifier("SIZE_SKL")        { Bonus = new Bonus() { Name = "ENLARGE_PERSON", Type = BonusType.Typeless, Value = -2  }}}},
